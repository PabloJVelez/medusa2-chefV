    ...
    <Tailwind>
      <Html className="font-sans bg-gray-100">
        ...
        <Body className="bg-white my-10 mx-auto w-full max-w-2xl">
          {/* Header */}
          <Section className="bg-gradient-to-r from-blue-500 to-blue-600 px-6 py-4">
            <Container>
              <Row>
                <Column>
                  <Heading className="text-2xl font-bold m-0 text-white">📧 Event Details Reminder</Heading>
                  <Text className="text-blue-100 m-0">Your confirmed chef event information</Text>
                </Column>
              </Row>
            </Container>
          </Section>
          ...
          <Container className="p-6">
            ...
            <Text className="text-gray-600 mb-6">
              Here are your confirmed event details. We're looking forward to creating an amazing culinary experience
              for you!
            </Text>
            ...
            {product && (
              <Section className="bg-green-50 rounded-lg p-6 mb-6">
                <Heading className="text-lg font-semibold text-gray-800 mb-4">Event Access</Heading>
            ...
            <Section className="bg-yellow-50 rounded-lg p-6 mb-6">
              ...
              <Text className="text-gray-600 mb-3">• Please ensure your kitchen is clean and ready for the chef</Text>
              <Text className="text-gray-600 mb-3">• Any dietary restrictions should be communicated in advance</Text>
              <Text className="text-gray-600">• Contact us immediately if you need to make any changes</Text>
            </Section>
