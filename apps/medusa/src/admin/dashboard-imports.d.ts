...
declare module '~dashboard/hooks/api/orders' {
  ...
  export function useOrderPreview(
    ...
    order?: HttpTypes.AdminOrderPreview;
    isLoading: boolean;
    isError: boolean;
    error: FetchError | null;
  };
...
declare module '~dashboard/components/common/skeleton' {
  export const TwoColumnPageSkeleton: React.ComponentType<{
    mainSections?: number;
...
declare module '~dashboard/components/layout/pages' {
  type TwoColumnPageComponent = React.ComponentType<{
    ...
    Side: React.ComponentType<{ children?: React.ReactNode }>;
    Sidebar: React.ComponentType<{ children?: React.ReactNode }>;
  };

  export const TwoColumnPage: TwoColumnPageComponent;
}
...
declare module '~dashboard/routes/orders/order-detail/components/active-order-claim-section' {
  ...
  export const ActiveOrderClaimSection: React.ComponentType<{ orderPreview: AdminOrderPreview }>;
}

declare module '~dashboard/routes/orders/order-detail/components/active-order-exchange-section' {
  import type { AdminOrderPreview } from '@medusajs/types';
  export const ActiveOrderExchangeSection: React.ComponentType<{ orderPreview: AdminOrderPreview }>;
}

declare module '~dashboard/routes/orders/order-detail/components/active-order-return-section' {
  import type { AdminOrderPreview } from '@medusajs/types';
  export const ActiveOrderReturnSection: React.ComponentType<{ orderPreview: AdminOrderPreview }>;
}
...
declare module '~dashboard/routes/orders/order-detail/components/order-active-edit-section' {
  ...
  export const OrderActiveEditSection: React.ComponentType<{ order: AdminOrder }>;
}

declare module '~dashboard/routes/orders/order-detail/components/order-activity-section' {
  import type { AdminOrder } from '@medusajs/types';
  export const OrderActivitySection: React.ComponentType<{ order: AdminOrder }>;
}

declare module '~dashboard/routes/orders/order-detail/components/order-customer-section' {
  import type { AdminOrder } from '@medusajs/types';
  export const OrderCustomerSection: React.ComponentType<{ order: AdminOrder }>;
}

declare module '~dashboard/routes/orders/order-detail/components/order-general-section' {
  import type { AdminOrder } from '@medusajs/types';
  export const OrderGeneralSection: React.ComponentType<{ order: AdminOrder }>;
}

declare module '~dashboard/routes/orders/order-detail/components/order-payment-section' {
  import type { AdminOrder } from '@medusajs/types';
  export const OrderPaymentSection: React.ComponentType<{ order: AdminOrder }>;
}
...
declare module '~dashboard/routes/orders/order-detail/breadcrumb' {
  export const OrderDetailBreadcrumb: React.ComponentType;
}
