 ...
 * Extracted and adapted from seed/menus.ts.
 */
import type {
...
const menuProductDataUsd: MenuTicketProductDataUsd[] = [
  {
    ...
    description:
      'A refined winter tasting: cocktails, canapes, herb-crusted lamb or salmon, roasted roots, and chocolate peppermint mousse. Ideal for intimate holiday gatherings.',
  ...
  },
  {
    title: 'Noir & Blanc',
    description:
      'Upscale event: French 75 and blackberry fizz, caprese and salmon blinis, surf & turf or herb chicken, truffle mash, and tiramisu. For milestone celebrations.',
