...
export interface MenuListHeaderProps extends PropsWithChildren {
  className?: string;
  heading?: ReactNode;
  text?: string;
...
export const MenuListHeader: FC<MenuListHeaderProps> = ({ heading, children, text, actions, customActions }) => {
