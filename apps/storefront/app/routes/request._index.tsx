...
export const eventRequestSchema = z.object({
  ...
  // Step 4: Party Size
  partySize: z.number().min(2, 'Minimum 2 guests required'),
...
export const meta: MetaFunction<typeof loader> = ({ data }) => {
  return [
    { title: 'Request Your Culinary Experience - Chef Luis Velez' },
    {
      name: 'description',
      content:
        'Book a personalized culinary experience with Chef Luis. Choose from cooking classes, plated dinners, or buffet-style events.',
    },
    { property: 'og:title', content: 'Request Your Culinary Experience - Chef Luis Velez' },
    {
      property: 'og:description',
      content:
        'Submit a request for your personalized culinary experience. Chef Luis will review and create a custom proposal for your event.',
    },
