...
const processSteps: ProcessStep[] = [
  ...
  },
  {
    ...
    description:
      "Chef Luis reviews your request and confirms availability. You'll receive a detailed proposal with menu customizations.",
  ...
  },
  {
    ...
    description:
      'Chef Luis arrives at your location with all ingredients and equipment. Relax and enjoy your personalized culinary experience.',
    timeline: 'Event day',
    icon: '🎉',
  },
];
...
const faqItems: FAQItem[] = [
  ...
  },
  {
    ...
    answer:
      "I'm based in Carson City, Nevada, and serve private events across Carson City, Reno, and the Lake Tahoe area. For vacation rentals, cabins, retreats, and events outside the immediate area, I'm happy to discuss travel arrangements.",
  },
  {
